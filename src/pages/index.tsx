    ...
    <div className='max-w-[1124px] h-screen mx-auto grid grid-cols-2 gap-28 items-center'>
      <main>
        ...
        <div className='mt-10 flex items-center gap-2'>
          ...
          <strong className='text-gray-100 tex-xl'>
        ...
        <p className='mt-4 tex-sm text-gray-300 leading-relaxed'>Após criar seu bolão, você receberá um código único que poderá usar para convidar outras pessoas 🚀</p>
